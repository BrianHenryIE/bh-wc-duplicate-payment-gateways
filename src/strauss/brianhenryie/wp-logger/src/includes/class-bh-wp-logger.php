...
namespace BrianHenryIE\WC_Duplicate_Gateway\BrianHenryIE\WP_Logger\includes;

use BrianHenryIE\WC_Duplicate_Gateway\BrianHenryIE\WP_Logger\includes\Functions;
use BrianHenryIE\WC_Duplicate_Gateway\BrianHenryIE\WP_Logger\admin\Admin;
use BrianHenryIE\WC_Duplicate_Gateway\BrianHenryIE\WP_Logger\admin\Logs_Page;
use BrianHenryIE\WC_Duplicate_Gateway\BrianHenryIE\WP_Logger\admin\Plugins_Page;
use BrianHenryIE\WC_Duplicate_Gateway\BrianHenryIE\WP_Logger\API\API_Interface;
use BrianHenryIE\WC_Duplicate_Gateway\BrianHenryIE\WP_Logger\API\Logger_Settings_Interface;
use BrianHenryIE\WC_Duplicate_Gateway\BrianHenryIE\WP_Logger\API\PHP_Error_Handler;
use BrianHenryIE\WC_Duplicate_Gateway\BrianHenryIE\WP_Logger\woocommerce\Log_Handler;
use BrianHenryIE\WC_Duplicate_Gateway\Katzgrau\KLogger\Logger as KLogger;
use BrianHenryIE\WC_Duplicate_Gateway\Psr\Log\AbstractLogger;
use BrianHenryIE\WC_Duplicate_Gateway\Psr\Log\LogLevel;
use BrianHenryIE\WC_Duplicate_Gateway\Psr\Log\NullLogger;
...
class BH_WP_Logger extends AbstractLogger {
	...
	public function __construct( $api, $settings ) {
		...
		if ( false && in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
			 ...
			 *
			 * @see \BrianHenryIE\WC_Duplicate_Gateway\Katzgrau\KLogger\Logger::formatMessage()
			 */
