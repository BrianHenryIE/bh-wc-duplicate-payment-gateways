<?php
/**
 * Tests for BH_WC_Duplicate_Gateway main setup class. Tests the actions are correctly added.
 *
 ...
 * Class Develop_Test
 */
class BH_WC_Duplicate_Gateway_Integration_Test extends \Codeception\TestCase\WPTestCase {
