<?php
/**
 * Tests for BH_WC_Duplicate_Payment_Gateways main setup class. Tests the actions are correctly added.
 *
 ...
 * @coversNothing
 */
class BH_WC_Duplicate_Payment_Gateways_Integration_Test extends \Codeception\TestCase\WPTestCase {
